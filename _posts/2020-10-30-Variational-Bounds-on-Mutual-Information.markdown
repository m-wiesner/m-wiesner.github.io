...
$$[\![\left(\phi\left(X_k\right) + \phi\left(X_j\right)\right) \circ G]\!]$$
...
&= \frac{1}{K} \left[\gamma_{X_j}\left(s, \tau\right) - \sum_{k=1}^K \gamma_{X_j}\left(s, \tau\right) \frac{\exp([\![\left(\phi\left(X_k\right) + \phi\left(X_j\right)\right) \circ G]\!])}{\sum_{i=1}^K \exp([\![\left(\phi\left(X_k\right) + \phi\left(X_i\right)\right) \circ G]\!])} \right] \\
\end{align}$$
