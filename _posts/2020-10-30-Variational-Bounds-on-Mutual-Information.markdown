...
MINE is an estimator for the mutual information parameterized by a neural network that is almost identical to InfoNCE. A critical part of the MINE objective was to note that the gradient update using $$I_{DV}$$ as the objective is biased.
