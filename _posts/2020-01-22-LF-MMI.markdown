...
& \mbox{ (3)   } & = E_{p\left(X_r, W_r\right)} [ - \log \left(\frac{p_{\theta}\left(X_r | W_r\right) p\left(W_r\right)}{\sum_{W} p_{\theta}\left(X , W\right)}\right)] \\\
& \mbox{ (4)   } & = E_{p\left(X_r, W_r\right)} [ - \log \left(\frac{p_{\theta}\left(X_r | W_r\right) p\left(W\right)}{\sum_{W} p_{\theta}\left(X_r | W\right) p\left(W\right)}\right)] 
\end{align}
$$
